...
const workbook2 = xlsx.readFile(path.resolve(__dirname, 'data_77.xlsx'));
const worksheet2 = workbook2.Sheets['Sheet1'];
const data2 = xlsx.utils.sheet_to_json(worksheet2);
const workbook3 = xlsx.readFile(path.resolve(__dirname, 'solvia.xlsx'));
const worksheet3 = workbook3.Sheets['Sheet1'];
const data3 = xlsx.utils.sheet_to_json(worksheet3);
const workbook4 = xlsx.readFile(path.resolve(__dirname, 'diglo.xlsx'));
